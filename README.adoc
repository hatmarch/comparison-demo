...
[TODO]
====
1. Trigger pipeline with git repo change (see link:https://github.com/siamaksade/tekton-cd-demo[this tutorial])
...
Builds might download faster if you install a local repo like nexus, however there currently is an issue with finding dependency information for `spring-data-jdbc-core-2.0.0.M1.pom`.  See:
